"""
Prosessdiagram slot_method.png
===============================
Seks-stegs flyt for slotting-eksempelet, tegnet med matplotlib.
"""
...
def draw(path: Path) -> None:
    ...
    fills = [S_FILLS[0], S_FILLS[1], S_FILLS[2], S_FILLS[3], S_FILLS[2], S_FILLS[4]]
    strokes = [S_DARKS[0], S_DARKS[1], S_DARKS[2], S_DARKS[3], S_DARKS[2], S_DARKS[4]]
    ...
    ax.text(
        6, 2.55, "Class-based slotting -- arbeidsflyt",
...
def main() -> None:
    ...
    draw(OUTPUT_DIR / "slot_method.png")
